...
A codicological inventory of manuscript witnesses to the *Dīvān* of Jahanshah Qaraqoyunlu (d. 872 AH / 1467 CE; pen name *Ḥaqīqī* / *Hakîkî*), Qaraqoyunlu ruler-poet. Persian-Turkish bilingual ghazals, *masnavīs*, and tuyughs; transmission extends from 15th-century institutional witnesses through 19th-century Anatolian and Iranian Azerbaijani Alevi shrine copies. v1.1.0 holds 14 catalogued entries (9 verified, 1 attribution-disputed, 1 lost-attested, 3 rejected) plus 10 ancillary reference extracts. The corpus is primarily textual: substantive decoration data was captured for 2 of the 14 audited entries originally, but one of those (Nuruosmaniye 04281) has since been reclassified as rejected after the colophon was read and identified the scribe as Jahanshah b. Baba Gejelu, a scribal-name homonym with the ruler-poet rather than an authorial attribution. The Decoration and material features section below details what material evidence is and is not present.
...
| Nuruosmaniye 04281 | 1677/78 | Nuruosmaniye, Istanbul | 326 | rejected (scribal-name homonym) | preserved as audit material; pertains to a non-Cihanşah codex |
| Baku-Doerfer hypothesis | n/a | (no codex; misidentified printed edition) | n/a | rejected (not a manuscript) | n/a |
| AMEA Manuscripts Institute (2021 acquisition) | post-2021 | AMEA, Baku | unknown | rejected (modern copy of Fatih 3808) | n/a |

Substantive decoration data was captured for 2 of 14 audited entries originally (Nuruosmaniye 04281 positive evidence; Diyarbakır Ulutürk *cönk* negative evidence); Nuruosmaniye 04281 has since been reclassified as rejected, so among the 11 active entries only Diyarbakır Ulutürk carries substantive (negative) decoration data. The Nuruosmaniye material is preserved in its register entry as audit evidence but pertains to a non-Cihanşah codex. Süleymaniye Fatih 3808 records a Mahmud I waqf seal only. BL Or 9493 carries Minorsky 1954's qualitative description with no formal codicological structure. The remaining 10 entries have no decoration data recovered through open-access sources; direct examination, ILL of base-text editions, or field correspondence is the recovery path.
...
Nuruosmaniye 04281 (Istanbul). 326-folio Persian Divan dated 1088 AH / 1677/78 CE, nestalik script. Previously catalogued as a candidate Hakîkî witness and reclassified as rejected on 2026-05-11 after direct reading of the colophon. The colophon on IIIF p. 331 names the scribe as Jahanshah b. Baba Gejelu (جهانشاه بن بابا گجلو), copied in Muḥarram 1088 AH; no author is named anywhere in the codex itself. The given name "Jahanshah" belongs to the scribe alone, plausibly bestowed in Alevi commemorative-naming honour of the ruler-poet (a venerated figure in Bektaşi-Alevi literary genealogy); the YEK cataloguer's Muʿīn *Ferheng-i Fārsī* V.961-962 reference, which prompted the original Hakîkî attribution, was an error driven by this scribal-name homonym. Four-fold disconfirmation: 326 folios cannot accommodate Cihanşah Qaraqoyunlu's documented 224-poem corpus (the five verified Cihanşah witnesses span 26-143 folios); the codex opens with 33+ *mufradāt* across folios 1b-3a, a genre with no presence in Cihanşah's documented corpus; 1677 Ottoman scriptorium context fits the period when Yusuf Hakîkî Baba's Sufi material was being extensively copied; the scribe profiles as an Anatolian Alevi-Bektaşi tekke copyist (Baba patronymic plus Shia-inflected closing formula *wa-ālihi al-amjād* omitting the Sunni *wa-ṣaḥbihi*). Decoration data captured during prior verification work is preserved in the register entry as audit material; the captured material comprises paper (*aharlı*, thin, vertical chain-lines, cream-coloured), binding (pasteboard with cherry-red leather, miklebli envelope flap, gilt-tooled sunken shemse central medallion, salbek pendant lobes, zencerek chain-pattern border ruling: a classic 17th-century Ottoman shemse cilt), and seals (Osman III tughralı waqf seal on f. 1a; İbrahim Hanif seal alongside). It pertains to a non-Cihanşah codex.
...
- Rich positive evidence captured but pertaining to a now-rejected entry: 1 of 14. Nuruosmaniye 04281 (see Featured witnesses above): paper, binding, seals all recovered from the YEK detail page; the codex is decisively not a Cihanşah witness following the 2026-05-11 colophon reading.
...
The corpus is not a corpus of decorated manuscripts: it is a poetry-witness census in which decoration is recorded when accessible. For material-culture research, no active entry in the corpus carries rich positive decoration evidence following the Nuruosmaniye 04281 reclassification; the previously positive-evidence Nuruosmaniye material is preserved in the rejected register entry as audit evidence.

## Coverage and scope

Source types in scope:

- Witness, candidate, and audit entries (14 entries total; 12 non-rejected): full divans, fragmentary copies, *mecmuʿa* / *jung* / *cönk* anthologies containing one or more Hakîkî ghazal, candidates with disputed attribution, and documented rejected leads.
...
> *Inclusion criteria for `rejected` and `candidate_probably_*` entries.* The three rejected entries are documented rebuttals to specific claims: (i) the Rahimov 1986 Baku edition (a printed edition once treated as a manuscript witness); (ii) the 2021 AMEA institutional acquisition (a photographic or microfilm copy of Süleymaniye Fatih 3808, not an independent codex); (iii) Nuruosmaniye 04281 (the colophon names a scribe Jahanshah b. Baba Gejelu whose given name coincides with the ruler-poet's, and a YEK cataloguer's Muʿīn V.961-962 reference treated this scribal-name homonym as authorial attribution; the underlying author is not Cihanşah Qaraqoyunlu). Each rejected entry carries a `rejection_type` sub-classification: `non_manuscript_misidentification`, `derivative_surrogate`, and `scribal_homonym_misidentification` respectively; see [`data/spec.md`](data/spec.md) for the formal field names. The remaining attribution-disputed candidate (Konya Hacı Bektaş BY0000010729) is included because it appears in a Bektaşi *mecmûʿa* with an ambiguous "Hakîkî" attribution; subsequent analysis assigned it a non-Cihanşah verdict by poetic context (Hakîkî's position among non-Hurufi neighbours argues against Cihanşah). Routine search false-positives (name-collision noise, namesake disambiguations, body-text catalogue matches) are recorded in per-session JSONs under [`data/searches/`](data/searches/), not included in the main witness list.
