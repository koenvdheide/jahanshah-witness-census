...
A codicological inventory of manuscript witnesses to the *Dīvān* of Jahanshah Qaraqoyunlu (d. 872 AH / 1467 CE; pen name *Ḥaqīqī* / *Hakîkî*), Qaraqoyunlu ruler-poet. Persian-Turkish bilingual ghazals, *masnavīs*, and tuyughs; transmission extends from 15th-century institutional witnesses through 19th-century Anatolian and Iranian Azerbaijani Alevi shrine copies. v1.1.0 documents 9 verified Cihanşah witnesses (5 on the TEIS Yesevi roster, 1 institutional fragment, 3 Alevi shrine witnesses in the Ocak tradition), plus 1 attribution-disputed candidate, 1 lost-attested entry, and 10 ancillary reference extracts (tezkire and research-log entries with verbatim sample verses where available). Three further register entries are preserved as audit material documenting specific attribution-claim rebuttals; see the Audit trail section near the end of this file. The corpus is primarily textual: substantive decoration data is captured for only one active entry (Diyarbakır Ulutürk *cönk*, negative evidence).
...
### Audit-rejected entries (3)

Three register entries are preserved as documented attribution-claim rebuttals rather than active witnesses. Full evidence is in the register file and the Audit trail section near the end of this file. One-line reasons:

- Baku-Doerfer hypothesis: the Rahimov 1986 Baku edition is a printed publication once treated as a manuscript witness; TEIS Yesevi confirms no Baku codex on the Cihanşah witness list.
- AMEA Manuscripts Institute (2021 acquisition): the announcement uses verbatim *əlyazma surəti* (manuscript reproduction); the AMEA holding is a microfilm or photographic copy of Süleymaniye Fatih 3808.
- Nuruosmaniye 04281: a 1677 Persian Divan whose colophon names a scribe Jahanshah b. Baba Gejelu; the given name belongs to the scribe alone, and the underlying author is not Cihanşah Qaraqoyunlu.

Substantive decoration data is captured for only one active entry (Diyarbakır Ulutürk *cönk*, negative evidence: an undecorated village rika notebook documented through Sohrabiabad and Akın 2019 photo plates). Süleymaniye Fatih 3808 records a Mahmud I waqf seal only. BL Or 9493 carries Minorsky 1954's qualitative description with no formal codicological structure. The remaining 8 active entries have no decoration data recovered through open-access sources; direct examination, ILL of base-text editions, or field correspondence is the recovery path.
...
Matenadaran MS 965 (Yerevan). Earliest extant witness, 879 AH / 1474–75 CE, roughly thirteen years before BL Or 9493. 54 folios, Persian and Turkish. Reached Yerevan through the Arutyun Gazaryan bequest (NYC Armenian collector) before consolidation into the Matenadaran in 1959; this finding (see [`data/searches/probe_2026-05-11_avenue_caucasus_maincontext.json`](data/searches/probe_2026-05-11_avenue_caucasus_maincontext.json)) rebuts an earlier Azerbaijani Wikipedia conflation with BL Or 9493's London itinerary. Decoration data unrecovered.
...
3. The geographic distribution is Ottoman-leaning rather than Turkmen-centred. Six of the 11 active entries are held in Turkey, one in Armenia, three in Iran (Tehran University plus two Iranian Azerbaijani shrine archives), and one in the UK. The Turkmen-Tabriz milieu of Cihanşah's own lifetime is largely absent from the surviving witnesses: BL Or 9493 (1488, Isfahan-scribed) and Matenadaran 965 (1474-75, Yerevan) are the closest 15th-century witnesses, while the bulk of the corpus reflects later Ottoman and Anatolian-Alevi transmission rather than the Tabrizi-Turkmen court literature that Cihanşah originally produced.

## Decoration and material features

The decoration data captured across the 11 active register entries breaks down as follows:

- Negative evidence with confidence: 1 of 11. Diyarbakır Ulutürk *cönk*: an undecorated village rika notebook documented through Sohrabiabad and Akın 2019 photo plates.
- Partial (seal only): 1 of 11. Süleymaniye Fatih 3808 carries a Mahmud I waqf seal on f. 1a per the Anatolia DB, but no paper, binding, or illumination data.
- Qualitative description only: 1 of 11. BL Or 9493 carries Minorsky 1954's qualitative judgment ("state of preservation perfect", "handsome little manuscript") without formal structural data.
- Unrecovered: 8 of 11. All other active entries lack recoverable material data through open-access sources. Recovery paths include direct examination, ILL of Hüseyinzade 1966, Rahimov 1986, or Demirci 1997 base-text editions, and field correspondence (Ilkhchi pirs' archive).

The corpus is not a corpus of decorated manuscripts: it is a poetry-witness census in which decoration is recorded when accessible. For material-culture research, no active entry carries rich positive decoration evidence.
...
- South Asia: Salar Jung Museum & Library (Hyderabad), Khuda Bakhsh Oriental Public Library (Patna), Rampur Raza Library, Asiatic Society Kolkata, the Indian government's NAMAMI / Kriti Sampada portal, and Aligarh Muslim University's Maulana Azad Library.
- Global aggregators and union catalogues: HMML (Hill Museum & Manuscript Library), WorldCat, Al-Furqan Islamic Heritage Foundation, the British Library's Endangered Archives Programme (EAP), the Digital Library of the Middle East (DLME), OPenn (Penn Libraries), HathiTrust, and the Internet Archive.
- Auction-house archives: Christie's, Sotheby's, and Bonhams.
...
Homonym disambiguation: every "Hakîkî" hit was tested against the chief homonym, Yusuf Hakîkî of Bursa (d. 893 AH / 1487 CE; an Ottoman Bektashi-Hurufi figure roughly contemporary with Cihanşah but textually distinct), and against the Anatolian *aşık*-tradition Hakîkîs and the 18th-century Kurdish Hakîkî recorded in St. Petersburg. Three diagnostic filters were applied per hit: a date filter (Cihanşah died in 872 AH / 1467 CE); a content-language filter (Cihanşah wrote in both Persian and Turkish; Yusuf only in Ottoman Turkish); and a textual-cluster test based on Hakîkî's documented appearance alongside Nesîmî in Hurufi *mecmua* anthologies, empirically established against Ankara Milli Kütüphane A 5252.

Where the search returned nothing: the auction archives surfaced no direct Jahānshāh witnesses, which confirms that the corpus is held entirely in institutional or private archives, never having entered the market. The Iranian national portals, the on-site catalogues at Tashkent's Beruni Institute, and the Tajik National Library and Rudaki Institute in Dushanbe returned no matches in scope; the search keys did appear in Russian, Uzbek, and Tajik forms, but the relevant manuscripts are either held only on-site or are simply not in those collections. Marashi-Najafi's institutional manuscript catalogue exists only as a print publication (the *Fihrist*, 30 of a planned 60 volumes); it is not yet available online in any searchable form. An announcement by the Azerbaijani news agency AzerTAC in November 2012, claiming that Alemdârî's 2001 Tehran edition contained "photographic reproductions" of the Tehran 8198 codex, was checked against the edition itself (retrieved in full from the Internet Archive) and shown to be incorrect: the edition is 320 pages of typeset text with no plates.

## Verification statuses

Each register entry carries a `verification_status` from a six-value enum (defined in [`data/spec.md`](data/spec.md)): `verified`, `verified_with_attribution_caveat`, `candidate_probably_non_cihansah`, `candidate_probably_yusuf_hakiki_or_other_homonym`, `lost_witness_attested_only`, `rejected`. Per-status counts live in [`data/witness_register.json`](data/witness_register.json) `stats.by_verification`. Routine search false-positives (name-collision noise, namesake disambiguations, body-text catalogue matches) are recorded in per-session JSONs under [`data/searches/`](data/searches/), not included in the main witness list.
...
Three register entries are preserved as documented rebuttals to specific attribution claims rather than as active witnesses. Each carries a `rejection_type` sub-classification:

- Baku-Doerfer hypothesis (`rejection_type: non_manuscript_misidentification`): the Rahimov 1986 Baku edition is a printed publication once treated as a manuscript witness. TEIS Yesevi confirms no Baku codex appears in the Cihanşah witness list. The 1986 publication was prepared from copies of manuscripts held elsewhere.
- AMEA Manuscripts Institute (2021 acquisition) (`rejection_type: derivative_surrogate`): the announcement uses verbatim *əlyazma surəti* (manuscript reproduction), denoting a microfilm or photographic copy. Acquired from Süleymaniye Library, where the unique Cihanşah witness is Fatih 3808; the AMEA holding is a Fatih 3808 surrogate, not an independent codex.
- Nuruosmaniye 04281 (`rejection_type: scribal_homonym_misidentification`): the colophon on IIIF p. 331 (read 2026-05-11) names the scribe as Jahanshah b. Baba Gejelu (جهانشاه بن بابا گجلو), Muḥarram 1088 AH / March-April 1677 CE; no author is named anywhere in the codex. The given name belongs to the scribe alone, plausibly bestowed in Alevi commemorative-naming honour of the ruler-poet (a venerated figure in Bektaşi-Alevi literary genealogy). The YEK cataloguer's Muʿīn *Ferheng-i Fārsī* V.961-962 reference, which prompted the original Hakîkî attribution, was an error driven by this scribal-name homonym. Four-fold disconfirmation of Cihanşah Qaraqoyunlu attribution: 326-folio codex cannot accommodate the documented 224-poem corpus (verified witnesses span 26-143 folios); the opening 33+ *mufradāt* across folios 1b-3a is a genre absent from the documented corpus; the 1677 Ottoman scriptorium context fits Yusuf Hakîkî Baba's known copying period; the scribe profiles as an Anatolian Alevi-Bektaşi tekke copyist (Baba patronymic plus Shia-inflected closing formula *wa-ālihi al-amjād* omitting the Sunni *wa-ṣaḥbihi*). The codex is most plausibly a Yusuf Hakîkî Divan; full colophon transcription, translation, and rejection_reason are preserved in the register entry.

The single attribution-disputed candidate (Konya Hacı Bektaş BY0000010729, `candidate_probably_non_cihansah`) is retained as active because it appears in a Bektaşi *mecmûʿa* with an ambiguous "Hakîkî" attribution that warranted scrutiny, but subsequent analysis assigned it a non-Cihanşah verdict by poetic context (Hakîkî's position among non-Hurufi neighbours argues against Cihanşah).
...
- Koen van der Heide: Conceptualization (joint); Methodology; Data Curation; Investigation (corpus building, search orchestration, source verification); Software (data analysis and curation); Writing, Original Draft; Visualization.
